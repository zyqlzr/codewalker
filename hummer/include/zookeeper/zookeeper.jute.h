...
int serialize_ACL(struct oarchive *out, const char *tag, struct ZOOACL *v);
int deserialize_ACL(struct iarchive *in, const char *tag, struct ZOOACL *v);
void deallocate_ACL(struct ZOOACL*);
struct Stat {
    int64_t czxid;
    int64_t mzxid;
    int64_t ctime;
