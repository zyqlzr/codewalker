...
typedef struct _Mutation__isset {
  _Mutation__isset() : isDelete(false), column(false), value(false), writeToWAL(false), timestamp(false) {}
  bool isDelete;
  bool column;
  bool value;
  bool writeToWAL;
...
class Mutation {
 public:
  ...
  static const char* ascii_fingerprint; // = "ECAE90B49C4CD40E8A134DAC8E9E8EF7";
  static const uint8_t binary_fingerprint[16]; // = {0xEC,0xAE,0x90,0xB4,0x9C,0x4C,0xD4,0x0E,0x8A,0x13,0x4D,0xAC,0x8E,0x9E,0x8E,0xF7};

  Mutation() : isDelete(false), column(""), value(""), writeToWAL(true), timestamp(9223372036854775807LL) {
  }
...
class BatchMutation {
 public:
  ...
  static const char* ascii_fingerprint; // = "9D5FFA15917400B819764E7C4E4C6133";
  static const uint8_t binary_fingerprint[16]; // = {0x9D,0x5F,0xFA,0x15,0x91,0x74,0x00,0xB8,0x19,0x76,0x4E,0x7C,0x4E,0x4C,0x61,0x33};
...
typedef struct _TaoAssocGetResult__isset {
  _TaoAssocGetResult__isset() : id2(false), id1Type(false), id2Type(false), time(false), dataVersion(false), data(false) {}
  bool id2;
  bool id1Type;
  bool id2Type;
  bool time;
  bool dataVersion;
  bool data;
} _TaoAssocGetResult__isset;

class TaoAssocGetResult {
 public:

  static const char* ascii_fingerprint; // = "62C2D09CFDA6764EAE246139DD2F0023";
  static const uint8_t binary_fingerprint[16]; // = {0x62,0xC2,0xD0,0x9C,0xFD,0xA6,0x76,0x4E,0xAE,0x24,0x61,0x39,0xDD,0x2F,0x00,0x23};
  ...
  _TaoAssocGetResult__isset __isset;
